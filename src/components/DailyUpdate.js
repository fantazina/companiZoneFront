...
const DailyUpdate = ({D_styles, onPage, seq}) => {
        ...
        <div>
            ...
            <h2 style={{ marginLeft : '20px' }}>글수정</h2>
                <div className={ D_styles.content }>
                    <div className={ D_styles.row_box }>
                        <div className={ D_styles.title_sel }>
                            <div className={ D_styles.select_div }>
                                ...
                                <div className={ D_styles.title_div }>
                                    <p>제목</p>
                                    <input className={ D_styles.inputbox } type='text' 
                                        value={writeDTO.title} name='title' onChange={ onInput }/>
                                    <div className={ D_styles.button }>
                        ...
                        <div className={ D_styles.img_div }>
                            <span>
                                {
                                    // 선택한 이미지를 미리보기
                    ...
                    <div className={ D_styles.text_img }>
                        <textarea className={ D_styles.textarea } name='content' value={ writeDTO.content } onChange={ onInput }></textarea>
                    </div>
            </div>
            </div>}
        </div>

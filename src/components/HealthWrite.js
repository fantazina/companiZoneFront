...
const HealthWrite = ({onPage, H_styles, userDTO, isLoggedIn}) => {
        ...
        <div>
            ...
            <h2 style={{ marginLeft : '20px' }}>글쓰기</h2>
                <div className={ H_styles.content }>
                    <div className={ H_styles.row_box }>
                        <div className={ H_styles.title_sel }>
                            <div className={ H_styles.select_div }>
                                ...
                                <div className={ H_styles.title_div }>
                                    <p>제목</p>
                                    <input className={ H_styles.inputbox } type='text' 
                                        value={ writeDTO.title } name='title' onChange={ onInput }/>
                                    <div className={ H_styles.button }>
                    ...
                    <div className={ H_styles.img_div }>
                        <span>
                            {
                                // 선택한 이미지를 미리보기
                        ...
                        <img id='camera' src={ camera } alt='카메라' onClick={ onCamera } className={ H_styles.img_camera } />
                        <input type='file' name='img[]' multiple='multiple' ref={ imgRef } onChange={ onImgInput } style={{ visibility: 'hidden' }} />
                    </div>

                    <div className={ H_styles.text_img }>
                        <textarea className={ H_styles.textarea } name='content' value={ writeDTO.content } onChange={ onInput }></textarea>

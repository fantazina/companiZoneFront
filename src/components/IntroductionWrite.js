...
const IntroductionWrite = ({onPage, I_styles, userDTO, isLoggedIn}) => {
    ...
    return (
        <div className={ I_styles.write_main }>
            { writeDTO.select }
            <h2 style={{ marginLeft : '20px' }}>글쓰기</h2>
                <div className={ I_styles.content }>
                    <div className={ I_styles.row_box }>
                        <div className={ I_styles.title_sel }>
                            <div className={ I_styles.select_div }>
                                ...
                                <div className={ I_styles.title_div }>
                                    <p>제목</p>
                                    <input className={ I_styles.inputbox } type='text' 
                                        value={ writeDTO.title } name='title' onChange={ onInput }/>
                                    <div className={ I_styles.button }>
                    ...
                    <div className={ I_styles.img_div }>
                        <span>
                            {
                                // 선택한 이미지를 미리보기
                        ...
                        <img id='camera' src={ camera } alt='카메라' onClick={ onCamera } className={ I_styles.img_camera } />
                        <input type='file' name='img[]' multiple='multiple' ref={ imgRef } onChange={ onImgInput } style={{ visibility: 'hidden' }} />
                    </div>

                    <div className={ I_styles.text_img }>
                        <textarea className={ I_styles.textarea } name='content' value={ writeDTO.content } onChange={ onInput }></textarea>

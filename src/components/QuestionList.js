...
const QuestionList = ({ onPage, onSeq, Q_styles, pg, onPg, mainOnPage }) => {
    ...
    useEffect(() => {
         axios.get(`https://port-0-companizoneback-ll53u2blrj4us1b.sel5.cloudtype.app/write/getList/4`, { params: { keyword: keyword , pg : pg } })
              .then(res => console.log(res.data))

        axios.get(`https://port-0-companizoneback-ll53u2blrj4us1b.sel5.cloudtype.app/write/getTotal/4`)
             .then(res => {
            let pl = []

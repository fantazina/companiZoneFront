...
const QuestionWrite = ({onPage, Q_styles, userDTO, isLoggedIn}) => {
        ...
        if(sw === 1){ 
            ...
            if(imgList.length > 0){
                ...
                .then(() => {
                    ...
                    axios.post(`https://port-0-companizoneback-ll53u2blrj4us1b.sel5.cloudtype.appn/write/write`, writeDTO)
                         .then(() => {
                          alert('글 작성이 완료되었습니다.')
                          onPage(0)
        ...
        <div>
            ...
            <h2 style={{ marginLeft : '20px' }}>글쓰기</h2>
                <div className={ Q_styles.content }>
                    <div className={ Q_styles.row_box }>
                        <div className={ Q_styles.title_sel }>
                            <div className={ Q_styles.select_div }>
                                ...
                                <div className={ Q_styles.title_div }>
                                    <p>제목</p>
                                    <input className={ Q_styles.inputbox } type='text' 
                                        value={ writeDTO.title } name='title' onChange={ onInput }/>
                                    <div className={ Q_styles.button }>
                    ...
                    <div className={ Q_styles.img_div }>
                        <span>
                            {
                                // 선택한 이미지를 미리보기
                    ...
                    <div className={ Q_styles.text_img }>
                        <textarea className={ Q_styles.textarea } name='content' value={ writeDTO.content } onChange={ onInput }></textarea>
